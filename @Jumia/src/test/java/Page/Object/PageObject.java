...
public class PageObject extends Driver {
	...
	private By btn_Continuer=By.xpath("/html/body/div/div[4]/form/div[2]/div[3]/div/button");
	//PageObject motpasse
	...
	driver.findElement(btn_Continuer).click();
	...
	driver.findElement(case_prixmin).sendKeys(Keys.CLEAR);
	}
	...
	driver.findElement(case_prixmax).sendKeys(Keys.CLEAR);
	}
